...
\begin{description}
    ...
    \item [Fakultätsübergreifende Mitglieder]
          Diese Mitglieder aus einer anderen Fakultät --- gele\-gent\-lich auch "`Wachhunde genannt"' --- sollen im Auftrag der Hochschulleitung dafür sorgen, dass das Berufungsverfahren ordnungskonform und zügig durchgeführt wird. Diese sind nicht an jeder Hochschule zu finden.
...
%Stand 2026-05
%Baden-Württemberg: §48 (3) LHG, alles (außer fak-übergreifende Mitglieder und SB-Beauftragter) sind in Kommission und haben Stimmrecht. Professorale Stimmmehrheit vorgeschrieben
%Bayern: §66 (4): Zusätzlich WiMis in Kommission haben Stimmrecht. Professorale Stimmmehrheit vorgeschrieben. 
%Berlin:
%Brandenburg:
%Bremen:
%Hamburg:
...
%Stand 2026-05
%Baden-Württemberg:
%Bayern: §66 (4) Satz 1 Nr. 2 (ein studentisches Mitglied) wird durch §27 (1) Sätze 2,3 insofern erweitert, dass ein Recht auf ein zweites beratendes Mitglied entsteht.
%Berlin:
%Brandenburg:
%Bremen:
%Hamburg:
