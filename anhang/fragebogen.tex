\chapter{Muster-Fragebogen für Lehrproben}\thispagestyle{fancy}\label{chp:fragebogen}
...
\noindent\begin{minipage}{\textwidth}
    \begin{center}
        \Large
        Lehrprobe\smallskip\par
        \large
        Professur \underline{\hspace{6cm}}
    \end{center}

    \parbox{\textwidth}{\large Ich habe folgende Lehrproben besucht:}\smallskip\par
    ...
    \begin{tabular}{|m{61mm}|m{20mm}|m{20mm}|}\hline
        ...
        \raisebox{3mm}[9mm]{\parbox{60mm}{War die Nutzungen von Medien (Tafel, Folien, \ldots) angemessen?}}                    & \multicolumn{2}{|m{40mm}|}{{\raisebox{0mm}[6mm]\bewertung}} \\\hline
